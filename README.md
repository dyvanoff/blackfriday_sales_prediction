...
- Feature engineering por categorías de producto
- Encoding de variables categóricas de alta cardinalidad
- Modelos de boosting optimizados
- Validación cruzada
...
El modelo permitirá:
- Personalizar ofertas por cliente
